...
namespace NorthwindService.Repositories
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        {
            this.db = db;
            //pre-load customers from db as a normal Dictionary with customerID as the key , then convert to a thread-safe ConcurrentDictionary
